...
//        docket.pathMapping("/v1/api");
        ...
        docket.enable(true)
                .apiInfo(buildApiInf())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sung.controller"))//要扫描的API(Controller)基础包
...
//    }
    ...
    private ApiInfo buildApiInf() {
        return new ApiInfoBuilder()
                .title("Docker-Example Test Doc")
                .contact(new Contact("Docker-Example", "", "1120_sungang@gmail.com"))
                .termsOfServiceUrl("")
                .version("1.0")
                .build();
    }
